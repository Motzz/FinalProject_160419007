...
import id.ac.ubaya.informatika.midtermproject_160419007.databinding.ResepCardLayoutBinding
...
class ResepListAdapter(val resepList: ArrayList<Resep>): RecyclerView.Adapter<ResepListAdapter.ResepViewHolder>(),ResepDetail {
    class ResepViewHolder(val view: ResepCardLayoutBinding):RecyclerView.ViewHolder(view.root)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ResepViewHolder {
        ...
        val view = DataBindingUtil.inflate<ResepCardLayoutBinding>(inflater,R.layout.resep_card_layout,parent,false)
    ...
    override fun onResepDetail(v: View) {
        val action = FragmentHomeDirections.actionFragmentDetail(v.tag.toString())//kirim data id
